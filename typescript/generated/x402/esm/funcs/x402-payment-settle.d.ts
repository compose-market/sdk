...
export declare function x402PaymentSettle(client: SDKCore, request: models.FacilitatorPaymentRequest, options?: RequestOptions): APIPromise<Result<operations.PaymentSettleResponse, errors.ErrorResponse | SDKError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=x402-payment-settle.d.ts.map