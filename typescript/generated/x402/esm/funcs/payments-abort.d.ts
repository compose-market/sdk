...
export declare function paymentsAbort(client: SDKCore, request: operations.AbortRequest, options?: RequestOptions): APIPromise<Result<operations.AbortResponse, errors.ErrorResponse | SDKError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=payments-abort.d.ts.map