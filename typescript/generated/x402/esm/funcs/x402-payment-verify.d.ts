...
export declare function x402PaymentVerify(client: SDKCore, request: models.FacilitatorPaymentRequest, options?: RequestOptions): APIPromise<Result<models.VerifyResponse, errors.ErrorResponse | SDKError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=x402-payment-verify.d.ts.map