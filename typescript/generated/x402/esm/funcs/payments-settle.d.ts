...
export declare function paymentsSettle(client: SDKCore, request: operations.SettleRequest, options?: RequestOptions): APIPromise<Result<{
    [k: string]: any;
...
//# sourceMappingURL=payments-settle.d.ts.map