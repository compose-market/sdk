...
export declare function composeKeysCreate(client: SDKCore, request: operations.CreateRequest, options?: RequestOptions): APIPromise<Result<models.KeyCreateResponse, errors.ErrorResponse | SDKError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=compose-keys-create.d.ts.map