 ...
 */
export declare function memorySchedulesTrigger(client: SDKCore, request: operations.SchedulesTriggerRequest, options?: RequestOptions): APIPromise<Result<models.MemoryScheduleTriggerResponse, SDKError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=memory-schedules-trigger.d.ts.map