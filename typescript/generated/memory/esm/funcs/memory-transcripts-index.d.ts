 ...
 */
export declare function memoryTranscriptsIndex(client: SDKCore, request: models.TranscriptIndexRequest, options?: RequestOptions): APIPromise<Result<models.TranscriptIndexResponse, errors.ErrorResponse | SDKError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=memory-transcripts-index.d.ts.map