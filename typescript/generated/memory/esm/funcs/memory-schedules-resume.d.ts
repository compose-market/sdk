 ...
 */
export declare function memorySchedulesResume(client: SDKCore, request: operations.SchedulesResumeRequest, options?: RequestOptions): APIPromise<Result<models.MemoryScheduleResumeResponse, SDKError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=memory-schedules-resume.d.ts.map