...
export declare function connectorsMcpInspect(client: SDKCore, request: operations.McpInspectRequest, options?: RequestOptions): APIPromise<Result<{
    [k: string]: any;
...
//# sourceMappingURL=connectors-mcp-inspect.d.ts.map