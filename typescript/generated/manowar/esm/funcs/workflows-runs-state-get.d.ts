...
export declare function workflowsRunsStateGet(client: SDKCore, request: operations.WorkflowRunsStateGetRequest, options?: RequestOptions): APIPromise<Result<{
    [k: string]: any;
...
//# sourceMappingURL=workflows-runs-state-get.d.ts.map