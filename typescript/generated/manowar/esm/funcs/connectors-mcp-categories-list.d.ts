...
export declare function connectorsMcpCategoriesList(client: SDKCore, options?: RequestOptions): APIPromise<Result<{
    [k: string]: any;
...
//# sourceMappingURL=connectors-mcp-categories-list.d.ts.map