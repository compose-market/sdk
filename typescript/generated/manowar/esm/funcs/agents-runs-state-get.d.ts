...
export declare function agentsRunsStateGet(client: SDKCore, request: operations.RunsStateGetRequest, options?: RequestOptions): APIPromise<Result<{
    [k: string]: any;
...
//# sourceMappingURL=agents-runs-state-get.d.ts.map