...
export declare function connectorsMcpSpawnGet(client: SDKCore, request: operations.McpSpawnGetRequest, options?: RequestOptions): APIPromise<Result<{
    [k: string]: any;
...
//# sourceMappingURL=connectors-mcp-spawn-get.d.ts.map