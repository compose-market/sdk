...
export declare function connectorsMcpGet(client: SDKCore, request: operations.McpGetRequest, options?: RequestOptions): APIPromise<Result<{
    [k: string]: any;
...
//# sourceMappingURL=connectors-mcp-get.d.ts.map