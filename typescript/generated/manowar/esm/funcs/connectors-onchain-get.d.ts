...
export declare function connectorsOnchainGet(client: SDKCore, request: operations.OnchainGetRequest, options?: RequestOptions): APIPromise<Result<{
    [k: string]: any;
...
//# sourceMappingURL=connectors-onchain-get.d.ts.map