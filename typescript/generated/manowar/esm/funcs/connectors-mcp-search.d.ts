...
export declare function connectorsMcpSearch(client: SDKCore, request: operations.McpSearchRequest, options?: RequestOptions): APIPromise<Result<{
    [k: string]: any;
...
//# sourceMappingURL=connectors-mcp-search.d.ts.map