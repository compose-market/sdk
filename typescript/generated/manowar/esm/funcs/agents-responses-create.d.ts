...
export declare function agentsResponsesCreate(client: SDKCore, request: operations.ResponsesCreateRequest, options?: RequestOptions): APIPromise<Result<{
    [k: string]: any;
...
//# sourceMappingURL=agents-responses-create.d.ts.map