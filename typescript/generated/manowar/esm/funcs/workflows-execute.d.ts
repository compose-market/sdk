...
export declare function workflowsExecute(client: SDKCore, request: operations.ExecuteRequest, options?: RequestOptions): APIPromise<Result<{
    [k: string]: any;
...
//# sourceMappingURL=workflows-execute.d.ts.map