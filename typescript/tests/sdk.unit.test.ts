...
test("buildApiError selects PaymentRequiredError for 402 with payment_required code", () => {
...
test("TimeoutError surfaces when the server is unreachable within the timeout", async () => {
