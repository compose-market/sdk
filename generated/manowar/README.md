...
* [`ErrorResponse`](./src/models/errors/error-response.ts): Runtime error response. Applicable to 6 of 33 methods.*
...
| ------------- | -------------------------------- | ------------------------------------------------------------------------ |
| `manowar`     | `https://runtime.compose.market` | Production manowar endpoint                                              |
| `compose-api` | `https://api.compose.market`     | Production API gateway for public agent and workflow execution endpoints |
| `local`       | `http://127.0.0.1:8787`          | Local manowar development endpoint                                       |
