...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.ToolsMcpSpawnRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/mcp/spawn")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ToolsMcpSpawnResponse$inboundSchema, {
