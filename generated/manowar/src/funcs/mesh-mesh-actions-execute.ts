...
export function meshMeshActionsExecute(
  client: ComposeMarketCore,
  request: operations.MeshActionsExecuteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MeshActionsExecuteResponse,
    | ComposeMarketError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.MeshActionsExecuteRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/mesh/actions/execute")();
  ...
  const context = {
    ...
    operationID: "mesh_actions_execute",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MeshActionsExecuteResponse$inboundSchema, {
