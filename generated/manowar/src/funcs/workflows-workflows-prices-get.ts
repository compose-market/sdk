...
export function workflowsWorkflowsPricesGet(
  client: ComposeMarketCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.WorkflowsPricesGetResponse,
    | ComposeMarketError
...
> {
  const path = pathToFunc("/workflow/prices")();
  ...
  const context = {
    ...
    operationID: "workflows_prices_get",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.WorkflowsPricesGetResponse$inboundSchema, {
      key: "object",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
