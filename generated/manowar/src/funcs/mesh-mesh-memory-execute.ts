...
export function meshMeshMemoryExecute(
  client: ComposeMarketCore,
  request: operations.MeshMemoryExecuteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MeshMemoryExecuteResponse,
    | ComposeMarketError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.MeshMemoryExecuteRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/mesh/memory")();
  ...
  const context = {
    ...
    operationID: "mesh_memory_execute",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MeshMemoryExecuteResponse$inboundSchema, {
