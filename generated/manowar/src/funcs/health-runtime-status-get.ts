...
export function healthRuntimeStatusGet(
  client: ComposeMarketCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RuntimeStatusGetResponse,
    | ComposeMarketError
...
> {
  ...
  const context = {
    ...
    operationID: "runtime_status_get",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RuntimeStatusGetResponse$inboundSchema, {
      key: "object",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
