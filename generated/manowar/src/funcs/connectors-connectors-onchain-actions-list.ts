...
export function connectorsConnectorsOnchainActionsList(
  client: ComposeMarketCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ConnectorsOnchainActionsListResponse,
    | ComposeMarketError
...
> {
  const path = pathToFunc("/onchain/actions")();
  ...
  const context = {
    ...
    operationID: "connectors_onchain_actions_list",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ConnectorsOnchainActionsListResponse$inboundSchema, {
