...
export function meshMeshHaiRegister(
  client: ComposeMarketCore,
  request: operations.MeshHaiRegisterRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MeshHaiRegisterResponse,
    | ComposeMarketError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.MeshHaiRegisterRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/mesh/hai/register")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MeshHaiRegisterResponse$inboundSchema, {
