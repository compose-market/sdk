...
export function meshMeshSynapseAnchor(
  client: ComposeMarketCore,
  request: operations.MeshSynapseAnchorRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MeshSynapseAnchorResponse,
    | ComposeMarketError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.MeshSynapseAnchorRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/mesh/synapse/anchor")();
  ...
  const context = {
    ...
    operationID: "mesh_synapse_anchor",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MeshSynapseAnchorResponse$inboundSchema, {
