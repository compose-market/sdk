...
export function toolsToolsGoatList(
  client: ComposeMarketCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ToolsGoatListResponse,
    | ComposeMarketError
...
> {
  const path = pathToFunc("/goat/tools")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ToolsGoatListResponse$inboundSchema, {
