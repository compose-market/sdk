...
export function connectorsConnectorsOnchainPluginsList(
  client: ComposeMarketCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ConnectorsOnchainPluginsListResponse,
    | ComposeMarketError
...
> {
  const path = pathToFunc("/onchain/plugins")();
  ...
  const context = {
    ...
    operationID: "connectors_onchain_plugins_list",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ConnectorsOnchainPluginsListResponse$inboundSchema, {
