...
export function meshMeshConclaveRun(
  client: ComposeMarketCore,
  request: operations.MeshConclaveRunRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MeshConclaveRunResponse,
    | ComposeMarketError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.MeshConclaveRunRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/mesh/conclave/run")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MeshConclaveRunResponse$inboundSchema, {
