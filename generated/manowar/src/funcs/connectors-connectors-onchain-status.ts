...
export function connectorsConnectorsOnchainStatus(
  client: ComposeMarketCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ConnectorsOnchainStatusResponse,
    | ComposeMarketError
...
> {
  const path = pathToFunc("/onchain/status")();
  ...
  const context = {
    ...
    operationID: "connectors_onchain_status",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ConnectorsOnchainStatusResponse$inboundSchema, {
