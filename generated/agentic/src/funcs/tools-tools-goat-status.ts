...
export function toolsToolsGoatStatus(
  client: ComposeMarketCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ToolsGoatStatusResponse,
    | ComposeMarketError
...
> {
  const path = pathToFunc("/goat/status")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ToolsGoatStatusResponse$inboundSchema, {
