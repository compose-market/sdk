...
export function toolsToolsGoatPluginsList(
  client: ComposeMarketCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ToolsGoatPluginsListResponse,
    | ComposeMarketError
...
> {
  const path = pathToFunc("/goat/plugins")();
  ...
  const context = {
    ...
    operationID: "tools_goat_plugins_list",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ToolsGoatPluginsListResponse$inboundSchema, {
