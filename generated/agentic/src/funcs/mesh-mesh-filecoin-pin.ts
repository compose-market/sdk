...
export function meshMeshFilecoinPin(
  client: ComposeMarketCore,
  request: operations.MeshFilecoinPinRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MeshFilecoinPinResponse,
    | ComposeMarketError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.MeshFilecoinPinRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/mesh/filecoin/pin")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MeshFilecoinPinResponse$inboundSchema, {
