...
export function meshMeshToolsExecute(
  client: ComposeMarketCore,
  request: operations.MeshToolsExecuteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MeshToolsExecuteResponse,
    | ComposeMarketError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.MeshToolsExecuteRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/mesh/tools/execute")();
  ...
  const context = {
    ...
    operationID: "mesh_tools_execute",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MeshToolsExecuteResponse$inboundSchema, {
