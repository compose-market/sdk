...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.MemoryRerankRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MemoryRerankResponse$inboundSchema, {
