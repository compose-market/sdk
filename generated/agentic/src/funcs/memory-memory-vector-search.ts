...
export function memoryMemoryVectorSearch(
  client: ComposeMarketCore,
  request: models.VectorSearchRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MemoryVectorSearchResponse,
    | ComposeMarketError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.VectorSearchRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "memory_vector_search",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MemoryVectorSearchResponse$inboundSchema, {
