...
export function toolsToolsMcpToolsList(
  client: ComposeMarketCore,
  request: operations.ToolsMcpToolsListRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ToolsMcpToolsListResponse,
    | ComposeMarketError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ToolsMcpToolsListRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/mcp/servers/{serverId}/tools")(pathParams);
  ...
  const context = {
    ...
    operationID: "tools_mcp_tools_list",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ToolsMcpToolsListResponse$inboundSchema, {
