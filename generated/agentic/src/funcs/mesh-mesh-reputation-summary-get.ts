...
export function meshMeshReputationSummaryGet(
  client: ComposeMarketCore,
  request: operations.MeshReputationSummaryGetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MeshReputationSummaryGetResponse,
    | ComposeMarketError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.MeshReputationSummaryGetRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/mesh/reputation/summary")();
  ...
  const context = {
    ...
    operationID: "mesh_reputation_summary_get",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MeshReputationSummaryGetResponse$inboundSchema, {
