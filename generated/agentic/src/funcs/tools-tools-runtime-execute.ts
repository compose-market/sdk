...
export function toolsToolsRuntimeExecute(
  client: ComposeMarketCore,
  request: operations.ToolsRuntimeExecuteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ToolsRuntimeExecuteResponse,
    | ComposeMarketError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ToolsRuntimeExecuteRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "tools_runtime_execute",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ToolsRuntimeExecuteResponse$inboundSchema, {
