...
export function healthRuntimeHealthCheck(
  client: ComposeMarketCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.RuntimeHealthCheckResponse,
    | ComposeMarketError
...
> {
  ...
  const context = {
    ...
    operationID: "runtime_health_check",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RuntimeHealthCheckResponse$inboundSchema, {
      key: "object",
    }),
    M.fail("4XX"),
    M.fail("5XX"),
