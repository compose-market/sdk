...
```typescript
import { ReceiptBody } from "@compose-market/sdk/models";

let value: ReceiptBody = {
  lineItems: [
    {
      key: "<key>",
      unit: "joule",
...
| `lineItems`                                                | [models.ReceiptLineItem](../models/receipt-line-item.md)[] | :heavy_minus_sign:                                         | N/A                                                        |                                                            |
