...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.AgentMemoryRecordTurnRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TurnRecordResponse$inboundSchema, {
      key: "AgentMemoryRecordTurnResponse",
    }),
