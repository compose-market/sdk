...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.AgentMemoryRememberRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RememberResponse$inboundSchema, {
      key: "AgentMemoryRememberResponse",
    }),
