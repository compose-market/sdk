...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.WorkflowsGetRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/api/memory/workflows/{workflowId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.WorkflowsGetResponse$inboundSchema, {
      key: "MemoryWorkflowResponse",
    }),
